...
function Card() {
  ...
  return (
    <div class="row">
      <div class="column">
        <div className="card">
          <Link to="/skills"  style={{textDecoration:"none", color: 'black'}} className="card1">
            <img
              className="img1"
      ...
      <div class="column">
        <div className="card">
          <Link to={"/toolkit"}  style={{textDecoration:"none", color: 'black'}}>
            <img
              className="img2"
